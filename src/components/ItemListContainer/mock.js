const products = [
    {id: '1', img: require('./img/carbon_resistors.png').default, alt: "carbon resistors", title: "Resistencias", discountPrice: 1000, price: 750, description: "Se denomina resistencia o resistor al componente electrónico diseñado para introducir una resistencia eléctrica determinada entre dos puntos de un circuito eléctrico.", category: "component"},
    {id: '2', img: require('./img/transistors.png').default, alt: "transistors", title: "Transistores", discountPrice: 1500, price: 1100, description: "Un transistor es un dispositivo activo con tres terminales, y estos tres terminales se conocen como Emisor, Base y Colector.", category: "component"},
    {id: '3', img: require('./img/diode.png').default, alt: "diode", title: "Diodos", discountPrice: 2000, price: 1300, description:"El diodo es un semiconductor cuya principal función es dejar pasar la corriente solo en una dirección, es decir, en un solo sentido y bloquear la corriente en el otro sentido.", category: "component"},
    ...
    {id: '6', img: require('./img/smd_components.png').default, alt: "smd components", title: "Componentes SMD", discountPrice: 1500, price: 1100, description:"Un componente SMD (Surface Mounting Device) es un componente electrónico que se suelda diréctamente en la superficie de la PCB. Tradicionalmente, los componentes se montaban introduciendo sus patas por un agujero y sodándolas al otro lado de la placa.", category: "component"},
