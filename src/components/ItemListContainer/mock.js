const products = [
    {id: '1', productImg: require('./img/carbon_resistors.png').default, alt: "carbon resistors", title: "Resistencias", discountPrice: 1000, price: 750, description: "Se denomina resistencia o resistor al componente electrónico diseñado para introducir una resistencia eléctrica determinada entre dos puntos de un circuito eléctrico"},
